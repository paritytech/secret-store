...
use secretstore_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	secretstore_runtime::api::dispatch,
	secretstore_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = sc_service::ServiceBuilder::new_full::<
			secretstore_runtime::opaque::Block, secretstore_runtime::RuntimeApi, crate::service::Executor
		>($config)?
